...
<div class="main-container">
	...
	<nav class="navbar bg-light fixed-top" style="box-shadow: 0px 3px 5px rgba(0, 0, 0, 0.20);">
		<div class="container-fluid">
			<div class="navbar-brand" >
				<a href="index"><img class="arrowleft" src="img/arrow_left.svg"></a>
				<span style="margin-left: 15px">RESUMO DO PEDIDO</span>

			</div>

      <a class="text-dark" href="index.php" style="text-decoration: none; ">
          <div class="d-flex carrinho" style="color:white; background: #2f8e85; border-radius: 7px;"><div style="padding-top: 5px; padding-bottom: 7px; padding-left: 10px; padding-right: 10px; text-align: center;">
            <small><small>Continuar Comprando</small></small>
          </div></div>
        </a>
	...
	<ol class="list-group" style="margin-top: 100px; margin-bottom: 95px; overflow: scroll; height:100%; scrollbar-width: thin;" id="listar-itens-carrinho">
...
<div class="area-pedidos">
	...
	<div class="d-grid gap-2 mt-4 abaixo"> 
		...
		<a href='finalizar' class="btn btn-primary botao-carrinho" style="background-color: #2f8e85; margin-top: 15px;">Finalizar Pedido</a>
	</div>
</div>
