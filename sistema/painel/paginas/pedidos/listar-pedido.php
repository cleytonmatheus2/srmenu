...
for ($i=0; $i < count($dados); $i++) { 
	...
	$item = $dados[$i]['item'];
		...
		$prods_totals = count($res2);
				...
				<div class="row itens">
				<div style="text-align: left; margin-bottom: -15px;"> <?php echo $quantidade ?> - <?php echo $nome_produto ?></div>		
...
<?php if($entrega == "Delivery"){ ?>
	...
	<div class="row valores">			
		<div >SubTotal</div>
		<div style="text-align: right; margin-top: -23px;">R$ <?php echo @$valor_dos_itensF ?></div>
	</div>			
<?php } ?>	
...
<div class="row valores">			
	...
	<div style="text-align: right; margin-top: -23px;"><?php echo @$entrega ?></div>	
</div>
<?php if($entrega == "Delivery"){ ?>
	<div class="row valores">			
		<div >Frete</div>
		<div style="text-align: right; margin-top: -23px;">R$ <?php echo @$taxa_entregaF ?></div>	
	</div>			
<?php } ?>
...
<div class="row valores">			
	...
	<div style="text-align: right; margin-top: -23px;"><?php echo @$tipo_pgto ?></div>	
</div>	
<div class="row valores">			
	<div >Está Pago</div>
	<div style="text-align: right; margin-top: -23px;"><b><?php echo @$pago ?></b></div>	
</div>
<?php if($total_pago != $valor){ ?>
	<div class="row valores">			
		<div >Valor Recebido</div>
		<div style="text-align: right; margin-top: -23px;">R$ <?php echo @$total_pagoF ?></div>	
	</div>			
<?php } ?>
...
<?php if($troco > 0){ ?>
	<div class="row valores">			
		<div >Troco</div>
		<div  style="text-align: right; margin-top: -23px;">R$ <?php echo @$trocoF ?></div>	
	</div>			
<?php } ?>
...
<div class="row valores" style="text-align: center; font-size: 17px; font-weight: 600;">	
