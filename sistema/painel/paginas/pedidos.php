		...
		<div class="col-md-12"  align="center">	
			<div> 
				<small >
					...
					<a title="Todas as Vendas" class="text-muted" href="#" onclick="buscarContas('Iniciado')"><i class="fa fa-square text-primary"></i> <span>Novo Pedido(<span id="ini_pedidos"></span>)</span></a> / 
