						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo $menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$grupos ?>"><a href="index.php?pagina=cupons"><i class="fa fa-angle-right"></i> Cupons</a></li>
							...
							<li class="treeview <?php echo $menu_produtos ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$produtos ?>"><a href="index.php?pagina=adicionais"><i class="fa fa-angle-right"></i> Adicionais</a></li>
