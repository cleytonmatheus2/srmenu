	...
	<nav class="navbar bg-light fixed-top" style="box-shadow: 0px 3px 5px rgba(0, 0, 0, 0.20);">
		<div class="container-fluid">
			<div class="navbar-brand" >
				...
				<a href="2sabores-<?php echo $url_cat ?>&sabores=<?php echo $sabores ?>"><big><img class="arrowleft" src="img/arrow_left.svg"></big></a>
...
//list-group //
	...
	<ol class="lista-variacao" style="margin-top: 65px">
	...
	<a href="observacoes-<?php echo $url ?>_<?php echo $nome_var ?>&sabores=<?php echo $sabores ?>" class="link-neutro <?php echo $ocultar_item ?>">
		...
		<li class="efeitohover d-flex"> 
			<div class="infos-itens">
				<div class="titulo-item"><?php echo $nome_var ?> <span class="subtitulo-item">(<?php echo $descricao ?>)</span></div>
