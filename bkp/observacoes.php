...
<div class="main-container" style="background:#fff;">
	...
	<nav class="navbar bg-light fixed-top" style="box-shadow: 0px 3px 5px rgba(0, 0, 0, 0.20);">
		<div class="container-fluid">
			<div class="navbar-brand" >
				...
				<a href="adicionais-<?php echo $url_completa ?>&sabores=<?php echo $sabores ?>"><big><img class="arrowleft" src="img/arrow_left.svg"></big></a>
				<?php }else{
	...
	<div class="destaque-qtd">
		<i class="bi bi-chat-square-text-fill" style="color: #545659;"></i>
		<b style="color: #545659;"> Alguma Observação?</b>
